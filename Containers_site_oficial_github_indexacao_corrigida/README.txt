...
- /Containers/ (endereço oficial; o caminho Contêineres_separados/ existe apenas como redirecionamento de compatibilidade)
- Página inicial: /Containers/index.html
...
- O Service Worker do FCM fica na raiz do site e usa caminhos relativos, compatíveis com GitHub Pages dentro de /Containers/.

CORREÇÕES DESTA VERSÃO
- Pacote sem pasta intermediária adicional: o conteúdo publicado começa diretamente na raiz do repositório /Containers/.
