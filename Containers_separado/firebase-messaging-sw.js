...
messaging.onBackgroundMessage(function(payload) {
    ...
    const opcoes = {
        ...
        icon: "/Containers/Containers_separado/icon-192.png",
        badge: "/Containers/Containers_separado/icon-192.png",
        tag: data.tipo || "controle-containers",
        renotify: true,
        data: {
            url: data.url || "/Containers/Containers_separado/index.html"
        }
    };
