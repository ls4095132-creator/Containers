...
async function salvarConfiguracoes(){
    try{
        const ref = db.ref("configuracoes/sistema");
        const dados = {
            quantidadeContainers: Math.max(1, Math.min(999,
                Math.floor(Number(document.getElementById("quantidadeContainers").value) || 60)
            )),
        ...
        // Atualiza somente as configurações utilizadas nesta tela.
        // Não apaga outras configurações existentes no Firebase.
